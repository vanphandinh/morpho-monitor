...
# Tests
npm test             # vitest run (all 586 tests across 43 files; 579 chạy + 7 skipped = live ntfy, NTFY_LIVE=1 để chạy)
npx vitest run       # same
