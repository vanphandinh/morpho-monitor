...
# Tests
npm test             # vitest run (all 566 tests across 38 files; 559 chạy + 7 skipped = live ntfy, NTFY_LIVE=1 để chạy)
npx vitest run       # same
