...
# Tests
npm test             # vitest run (all 550 tests across 37 files; 543 chạy + 7 skipped = live ntfy, NTFY_LIVE=1 để chạy)
npx vitest run       # same
